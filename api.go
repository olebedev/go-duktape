...
func (d *Context) CompileFile(flags uint, path string) {
	...
	C._duk_compile_file(d.cContext, C.duk_uint_t(flags), __path__)
}
...
func (d *Context) CompileLstring(flags uint, src string, len int) {
	...
	C._duk_compile_lstring(d.cContext, C.duk_uint_t(flags), __src__, C.duk_size_t(len))
}
...
func (d *Context) CompileLstringFilename(flags uint, src string, len int) {
	__src__ := C.CString(src)
	defer C.free(unsafe.Pointer(__src__))
	C._duk_compile_lstring_filename(d.cContext, C.duk_uint_t(flags), __src__, C.duk_size_t(len))
}
...
func (d *Context) CompileString(flags uint, src string) {
	__src__ := C.CString(src)
	defer C.free(unsafe.Pointer(__src__))
	C._duk_compile_string(d.cContext, C.duk_uint_t(flags), __src__)
}
...
func (d *Context) Error(errCode int, a ...interface{}) {
	...
	C._duk_error(d.cContext, C.duk_errcode_t(errCode), __str__)
}
...
func (d *Context) ErrorRaw(errCode int, filename string, line int, errMsg string) {
	...
	C._duk_error_raw(d.cContext, C.duk_errcode_t(errCode), __filename__, C.duk_int_t(line), __errMsg__)
}
...
func (d *Context) EvalFile(path string) {
	__path__ := C.CString(path)
	defer C.free(unsafe.Pointer(__path__))
	C._duk_eval_file(d.cContext, __path__)
}
...
func (d *Context) EvalFileNoresult(path string) {
	__path__ := C.CString(path)
	defer C.free(unsafe.Pointer(__path__))
	C._duk_eval_file_noresult(d.cContext, __path__)
}
...
func (d *Context) EvalLstring(src string, len int) {
	__src__ := C.CString(src)
	defer C.free(unsafe.Pointer(__src__))
	C._duk_eval_lstring(d.cContext, __src__, C.duk_size_t(len))
}
...
func (d *Context) EvalLstringNoresult(src string, len int) {
	__src__ := C.CString(src)
	defer C.free(unsafe.Pointer(__src__))
	C._duk_eval_lstring_noresult(d.cContext, __src__, C.duk_size_t(len))
}

// See: http://duktape.org/api.html#duk_eval_noresult
func (d *Context) EvalNoresult() {
	C._duk_eval_noresult(d.cContext)
}
...
func (d *Context) EvalString(src string) {
	__src__ := C.CString(src)
	defer C.free(unsafe.Pointer(__src__))
	C._duk_eval_string(d.cContext, __src__)
}
...
func (d *Context) EvalStringNoresult(src string) {
	__src__ := C.CString(src)
	defer C.free(unsafe.Pointer(__src__))
	C._duk_eval_string_noresult(d.cContext, __src__)
}
...
func (d *Context) GetPropString(objIndex int, key string) bool {
	__key__ := C.CString(key)
	defer C.free(unsafe.Pointer(__key__))
	return int(C.duk_get_prop_string(d.cContext, C.duk_idx_t(objIndex), __key__)) == 1
}

// See: http://duktape.org/api.html#duk_get_prototype
func (d *Context) GetPrototype(index int) {
	C.duk_get_prototype(d.cContext, C.duk_idx_t(index))
}

// See: http://duktape.org/api.html#duk_get_string
func (d *Context) GetString(i int) string {
	if s := C.duk_get_string(d.cContext, C.duk_idx_t(i)); s != nil {
		return C.GoString(s)
	}
	return ""
}
...
func (d *Context) HasPropString(objIndex int, key string) bool {
	__key__ := C.CString(key)
	defer C.free(unsafe.Pointer(__key__))
	return int(C.duk_has_prop_string(d.cContext, C.duk_idx_t(objIndex), __key__)) == 1
}

// See: http://duktape.org/api.html#duk_hex_decode
func (d *Context) HexDecode(index int) {
	C.duk_hex_decode(d.cContext, C.duk_idx_t(index))
}

// See: http://duktape.org/api.html#duk_hex_encode
func (d *Context) HexEncode(index int) string {
	if s := C.duk_hex_encode(d.cContext, C.duk_idx_t(index)); s != nil {
		return C.GoString(s)
	}
	return ""
}
...
func (d *Context) New(nargs int) {
	C.duk_new(d.cContext, C.duk_idx_t(nargs))
}
...
func (d *Context) PcompileFile(flags uint, path string) error {
	...
	result := int(C._duk_pcompile_file(d.cContext, C.duk_uint_t(flags), __path__))
	return d.castStringToError(result)
}
...
func (d *Context) PcompileLstring(flags uint, src string, len int) error {
	...
	result := int(C._duk_pcompile_lstring(d.cContext, C.duk_uint_t(flags), __src__, C.duk_size_t(len)))
	return d.castStringToError(result)
}
...
func (d *Context) PcompileLstringFilename(flags uint, src string, len int) error {
	...
	result := int(C._duk_pcompile_lstring_filename(d.cContext, C.duk_uint_t(flags), __src__, C.duk_size_t(len)))
	return d.castStringToError(result)
}
...
func (d *Context) PcompileString(flags uint, src string) error {
	...
	result := int(C._duk_pcompile_string(d.cContext, C.duk_uint_t(flags), __src__))
	return d.castStringToError(result)
}
...
func (d *Context) PcompileStringFilename(flags uint, src string) error {
	...
	result := int(C._duk_pcompile_string_filename(d.cContext, C.duk_uint_t(flags), __src__))
	return d.castStringToError(result)
}

// See: http://duktape.org/api.html#duk_peval
func (d *Context) Peval() error {
	result := int(C._duk_peval(d.cContext))
	return d.castStringToError(result)
}
...
func (d *Context) PevalFile(path string) error {
	...
	result := int(C._duk_peval_file(d.cContext, __path__))
	return d.castStringToError(result)
}
...
func (d *Context) PevalFileNoresult(path string) int {
	__path__ := C.CString(path)
	defer C.free(unsafe.Pointer(__path__))
	return int(C._duk_peval_file_noresult(d.cContext, __path__))
}
...
func (d *Context) PevalLstring(src string, len int) error {
	...
	result := int(C._duk_peval_lstring(d.cContext, __src__, C.duk_size_t(len)))
	return d.castStringToError(result)
...
func (d *Context) PevalLstringNoresult(src string, len int) int {
	__src__ := C.CString(src)
	defer C.free(unsafe.Pointer(__src__))
	return int(C._duk_peval_lstring_noresult(d.cContext, __src__, C.duk_size_t(len)))
}

// See: http://duktape.org/api.html#duk_peval_noresult
func (d *Context) PevalNoresult() int {
	return int(C._duk_peval_noresult(d.cContext))
}
...
func (d *Context) PevalString(src string) error {
	...
	result := int(C._duk_peval_string(d.cContext, __src__))
	return d.castStringToError(result)
}
...
func (d *Context) PevalStringNoresult(src string) int {
	...
	return int(C._duk_peval_string_noresult(d.cContext, __src__))
}
...
func (d *Context) PopN(count int) {
	...
	C.duk_pop_n(d.cContext, C.duk_idx_t(count))
}

// See: http://duktape.org/api.html#duk_push_array
func (d *Context) PushArray() int {
	return int(C.duk_push_array(d.cContext))
}
...
func (d *Context) PushBoolean(val bool) {
	...
	C.duk_push_boolean(d.cContext, C.duk_bool_t(__val__))
}
...
func (d *Context) PushErrorObject(errCode int, a ...interface{}) {
	...
	__str__ := C.CString(str)
	defer C.free(unsafe.Pointer(__str__))
	C._duk_push_error_object(d.cContext, C.duk_errcode_t(errCode), __str__)
}
...
func (d *Context) PushLstring(str string, len int) string {
	__str__ := C.CString(str)
	defer C.free(unsafe.Pointer(__str__))
	if s := C.duk_push_lstring(d.cContext, __str__, C.duk_size_t(len)); s != nil {
		return C.GoString(s)
	}
	return ""
}
...
func (d *Context) PushString(str string) string {
	__str__ := C.CString(str)
	defer C.free(unsafe.Pointer(__str__))
	if s := C.duk_push_string(d.cContext, __str__); s != nil {
		return C.GoString(s)
	}
	return ""
}
...
func (d *Context) PushStringFile(path string) string {
	__path__ := C.CString(path)
	defer C.free(unsafe.Pointer(__path__))
	if s := C._duk_push_string_file(d.cContext, __path__); s != nil {
		return C.GoString(s)
	}
	return ""
}
...
func (d *Context) PutGlobalString(key string) bool {
	__key__ := C.CString(key)
	defer C.free(unsafe.Pointer(__key__))
	return int(C.duk_put_global_string(d.cContext, __key__)) == 1
}

// See: http://duktape.org/api.html#duk_put_prop
func (d *Context) PutProp(objIndex int) bool {
	return int(C.duk_put_prop(d.cContext, C.duk_idx_t(objIndex))) == 1
}

// See: http://duktape.org/api.html#duk_put_prop_index
func (d *Context) PutPropIndex(objIndex int, arrIndex uint) bool {
	return int(C.duk_put_prop_index(d.cContext, C.duk_idx_t(objIndex), C.duk_uarridx_t(arrIndex))) == 1
}
...
func (d *Context) SafeToLstring(index int, outLen int) string {
	if s := C.duk_safe_to_lstring(d.cContext, C.duk_idx_t(index), (*C.duk_size_t)(unsafe.Pointer(&outLen))); s != nil {
		return C.GoString(s)
	}
	return ""
}
...
func (d *Context) SafeToString(index int) string {
	if s := C._duk_safe_to_string(d.cContext, C.duk_idx_t(index)); s != nil {
		return C.GoString(s)
	}
	return ""
}
